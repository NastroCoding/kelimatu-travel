...
@section('content')
                    ...
                    <div class="relative bg-white rounded-lg shadow">
                        ...
                        <form action="/admin/team/update/{{ $team->id }}" method="post" enctype="multipart/form-data">
                            <div class="p-4 md:p-5 space-y-4">
                                @csrf
                                <div class="mb-5">
                                    <label class="block mb-2 text-sm font-medium text-gray-900" for="file_input_edit_{{ $team->id }}">Upload
                                        foto</label>
                                    <input
                                        ...
                                        id="file_input_edit_{{ $team->id }}" type="file" accept="image/*" name="image">
    ...
    <script>
        $(document).ready(function() {
            ...
            @foreach ($teams as $team)
                document.getElementById('file_input_edit_{{ $team->id }}').addEventListener('change', function(event) {
