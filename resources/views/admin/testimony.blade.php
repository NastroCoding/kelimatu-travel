            ...
            <div id="edit-modal" aria-hidden="true" data-modal-backdrop="static"
                ...
                <div class="relative p-4 w-full max-w-2xl max-h-full">
                    ...
                    <div class="relative bg-white rounded-lg shadow">
                        ...
                        <!-- Modal body -->
                        <form method="post" action="/admin/testimony/update/{{ $testimony->id }}" enctype="multipart/form-data">
                            @csrf
                            <div class="p-4 md:p-5 space-y-4">
                                <div class="mb-5">
                                    <label class="block mb-2 text-sm font-medium text-gray-900" for="file_input">Upload
                                    ...
                                    <img id="image_preview" class="mt-4 w-3/5 rounded-lg" src="{{ Storage::url($testimony->image) }}" />
                                </div>
                                <div class="mb-5">
                                    <label for="nama" class="block mb-2 text-sm font-medium text-gray-900 ">Nama <span
                                            class="text-red-700">*</span></label>
